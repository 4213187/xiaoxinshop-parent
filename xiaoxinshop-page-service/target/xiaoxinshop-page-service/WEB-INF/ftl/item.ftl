    ...
    <script>
        ...
        app.controller('itemController', function ($scope) {
            ...
            $scope.addToCart=function(){
                $http.get('http://localhost:9007/cart/addGoodsToCartList?itemId='
...
<body ng-app="xiaoxinshop" ng-controller="itemController" ng-init="num=1;loadSku()">
<#--图片列表 -->
            ...
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        ...
                        <li class="f-item"><a href="home.html" target="_blank">我的小新商城</a></li>
                        <li class="f-item space"></li>
            ...
            <div class="py-container">
                <div class="yui3-g Logo">
                    <div class="yui3-u Left logoArea">
                        <a class="logo-bd" title="小新商城" href="JD-index.html" target="_blank"></a>
                    </div>
